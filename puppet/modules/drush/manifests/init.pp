class drush::install {
  ...
  exec { "drush_console_table":
    command => "/usr/bin/wget --no-check-certificate -q http://download.pear.php.net/package/Console_Table-1.1.3.tgz ; tar -zxf Console_Table-1.1.3.tgz ; rm Console_Table-1.1.3.tgz ; sudo mv Console_Table-1.1.3 /usr/share/php/drush/lib",
    creates => "/usr/share/php/drush/lib/Console_Table-1.1.3",
    require => [
        Exec["pear_install_drush"],
        Package['wget'],
    ]
