...
class service_container_prod extends \Drupal\Core\DependencyInjection\Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'access_check.search' => 'getAccessCheck_SearchService',
            'access_check.search_plugin' => 'getAccessCheck_SearchPluginService',
            ...
            'route_subscriber.search' => 'getRouteSubscriber_SearchService',
    ...
    /**
     * Gets the 'access_check.search' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Drupal\search\Access\SearchAccessCheck A Drupal\search\Access\SearchAccessCheck instance.
     */
    protected function getAccessCheck_SearchService()
    {
        return $this->services['access_check.search'] = new \Drupal\search\Access\SearchAccessCheck($this->get('plugin.manager.search'));
    }

    /**
     * Gets the 'access_check.search_plugin' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Drupal\search\Access\SearchPluginAccessCheck A Drupal\search\Access\SearchPluginAccessCheck instance.
     */
    protected function getAccessCheck_SearchPluginService()
    {
        return $this->services['access_check.search_plugin'] = new \Drupal\search\Access\SearchPluginAccessCheck($this->get('plugin.manager.search'));
    }
    ...
    protected function getAccessManagerService()
    {
        ...
        $instance->addCheckService('access_check.theme');
        $instance->addCheckService('access_check.custom');
        $instance->addCheckService('access_check.contact_personal');
        ...
        $instance->addCheckService('access_check.node.add');
        $instance->addCheckService('access_check.overlay.dismiss_message');
        $instance->addCheckService('access_check.search');
        $instance->addCheckService('access_check.search_plugin');
        $instance->addCheckService('access_check.shortcut.link');
        $instance->addCheckService('access_check.shortcut.shortcut_set_edit');
        $instance->addCheckService('access_check.shortcut.shortcut_set_switch');
        $instance->addCheckService('access_check.cron');
        $instance->addCheckService('access_check.update.manager_access');
     ...
     * 
     * @throws InactiveScopeException when the 'access_subscriber' service is requested while the 'request' scope is not active
     */
    protected function getAccessSubscriberService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('access_subscriber', 'request');
        }

        $a = $this->get('current_user');

        $this->services['access_subscriber'] = $this->scopedServices['request']['access_subscriber'] = $instance = new \Drupal\Core\EventSubscriber\AccessSubscriber($this->get('access_manager'), $a);
    ...
    {
        return $this->services['comment.manager'] = new \Drupal\comment\CommentManager($this->get('field.info'), $this->get('entity.manager'));
    }
    ...
    {
        return $this->services['config.context.factory'] = new \Drupal\Core\Config\Context\ConfigContextFactory($this->get('event_dispatcher'), $this->get('uuid'));
    }
    ...
    {
        return $this->services['container.namespaces'] = new \ArrayObject(array('Drupal\\block' => '/vagrant/sites/drupal8/core/modules/block/lib', 'Drupal\\breakpoint' => '/vagrant/sites/drupal8/core/modules/breakpoint/lib', 'Drupal\\ckeditor' => '/vagrant/sites/drupal8/core/modules/ckeditor/lib', 'Drupal\\color' => '/vagrant/sites/drupal8/core/modules/color/lib', 'Drupal\\comment' => '/vagrant/sites/drupal8/core/modules/comment/lib', 'Drupal\\config' => '/vagrant/sites/drupal8/core/modules/config/lib', 'Drupal\\contact' => '/vagrant/sites/drupal8/core/modules/contact/lib', 'Drupal\\contextual' => '/vagrant/sites/drupal8/core/modules/contextual/lib', 'Drupal\\custom_block' => '/vagrant/sites/drupal8/core/modules/block/custom_block/lib', 'Drupal\\datetime' => '/vagrant/sites/drupal8/core/modules/datetime/lib', 'Drupal\\dblog' => '/vagrant/sites/drupal8/core/modules/dblog/lib', 'Drupal\\edit' => '/vagrant/sites/drupal8/core/modules/edit/lib', 'Drupal\\editor' => '/vagrant/sites/drupal8/core/modules/editor/lib', 'Drupal\\entity' => '/vagrant/sites/drupal8/core/modules/entity/lib', 'Drupal\\entity_reference' => '/vagrant/sites/drupal8/core/modules/entity_reference/lib', 'Drupal\\field' => '/vagrant/sites/drupal8/core/modules/field/lib', 'Drupal\\field_ui' => '/vagrant/sites/drupal8/core/modules/field_ui/lib', 'Drupal\\file' => '/vagrant/sites/drupal8/core/modules/file/lib', 'Drupal\\filter' => '/vagrant/sites/drupal8/core/modules/filter/lib', 'Drupal\\help' => '/vagrant/sites/drupal8/core/modules/help/lib', 'Drupal\\history' => '/vagrant/sites/drupal8/core/modules/history/lib', 'Drupal\\image' => '/vagrant/sites/drupal8/core/modules/image/lib', 'Drupal\\menu' => '/vagrant/sites/drupal8/core/modules/menu/lib', 'Drupal\\menu_link' => '/vagrant/sites/drupal8/core/modules/menu_link/lib', 'Drupal\\node' => '/vagrant/sites/drupal8/core/modules/node/lib', 'Drupal\\number' => '/vagrant/sites/drupal8/core/modules/number/lib', 'Drupal\\options' => '/vagrant/sites/drupal8/core/modules/options/lib', 'Drupal\\overlay' => '/vagrant/sites/drupal8/core/modules/overlay/lib', 'Drupal\\path' => '/vagrant/sites/drupal8/core/modules/path/lib', 'Drupal\\rdf' => '/vagrant/sites/drupal8/core/modules/rdf/lib', 'Drupal\\search' => '/vagrant/sites/drupal8/core/modules/search/lib', 'Drupal\\shortcut' => '/vagrant/sites/drupal8/core/modules/shortcut/lib', 'Drupal\\system' => '/vagrant/sites/drupal8/core/modules/system/lib', 'Drupal\\taxonomy' => '/vagrant/sites/drupal8/core/modules/taxonomy/lib', 'Drupal\\text' => '/vagrant/sites/drupal8/core/modules/text/lib', 'Drupal\\toolbar' => '/vagrant/sites/drupal8/core/modules/toolbar/lib', 'Drupal\\tour' => '/vagrant/sites/drupal8/core/modules/tour/lib', 'Drupal\\update' => '/vagrant/sites/drupal8/core/modules/update/lib', 'Drupal\\user' => '/vagrant/sites/drupal8/core/modules/user/lib', 'Drupal\\views_ui' => '/vagrant/sites/drupal8/core/modules/views_ui/lib', 'Drupal\\views' => '/vagrant/sites/drupal8/core/modules/views/lib', 'Drupal\\standard' => '/vagrant/sites/drupal8/core/profiles/standard/lib', 'Drupal\\Core\\Entity' => '/vagrant/sites/drupal8/core/lib', 'Drupal\\Core\\Field' => '/vagrant/sites/drupal8/core/lib', 'Drupal\\Core\\Http' => '/vagrant/sites/drupal8/core/lib', 'Drupal\\Core\\TypedData' => '/vagrant/sites/drupal8/core/lib', 'Drupal\\Core\\Validation' => '/vagrant/sites/drupal8/core/lib', 'Drupal\\Component\\Annotation' => '/vagrant/sites/drupal8/core/lib'));
    }
    ...
    {
        return $this->services['controller.dialog'] = new \Drupal\Core\Controller\DialogController($this->get('http_kernel'), $this->get('title_resolver'));
    }
    ...
    {
        return $this->services['controller.page'] = new \Drupal\Core\Controller\HtmlPageController($this->get('http_kernel'), $this->get('controller_resolver'), $this->get('string_translation'), $this->get('title_resolver'));
    }
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addSubscriberService('route_subscriber.search', 'Drupal\\search\\Routing\\SearchRouteSubscriber');
    ...
    protected function getKernelDestructSubscriberService()
    {
        ...
        $instance->registerService('views.route_subscriber');
    ...
    {
        return $this->services['language_manager'] = new \Drupal\Core\Language\LanguageManager($this->get('state'), $this->get('module_handler'));
    }
     ...
     * 
     * @throws InactiveScopeException when the 'plugin.manager.menu.local_task' service is requested while the 'request' scope is not active
     */
    protected function getPlugin_Manager_Menu_LocalTaskService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('plugin.manager.menu.local_task', 'request');
        }

        return $this->services['plugin.manager.menu.local_task'] = $this->scopedServices['request']['plugin.manager.menu.local_task'] = new \Drupal\Core\Menu\LocalTaskManager($this->get('controller_resolver'), $this->get('request'), $this->get('router.route_provider'), $this->get('module_handler'), $this->get('cache.cache'), $this->get('language_manager'), $this->get('access_manager'), $this->get('current_user'));
    }
    ...
    {
        return $this->services['plugin.manager.search'] = new \Drupal\search\SearchPluginManager($this->get('container.namespaces'), $this->get('config.factory'), $this->get('cache.cache'), $this->get('language_manager'));
    }
    ...
    /**
     * Gets the 'route_subscriber.search' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Drupal\search\Routing\SearchRouteSubscriber A Drupal\search\Routing\SearchRouteSubscriber instance.
     */
    protected function getRouteSubscriber_SearchService()
    {
        return $this->services['route_subscriber.search'] = new \Drupal\search\Routing\SearchRouteSubscriber($this->get('plugin.manager.search'));
    }
    ...
    {
        return $this->services['twig.loader.filesystem'] = new \Twig_Loader_Filesystem('/vagrant/sites/drupal8');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'container.namespaces' => array(
                'Drupal\\block' => '/vagrant/sites/drupal8/core/modules/block/lib',
                'Drupal\\breakpoint' => '/vagrant/sites/drupal8/core/modules/breakpoint/lib',
                'Drupal\\ckeditor' => '/vagrant/sites/drupal8/core/modules/ckeditor/lib',
                'Drupal\\color' => '/vagrant/sites/drupal8/core/modules/color/lib',
                'Drupal\\comment' => '/vagrant/sites/drupal8/core/modules/comment/lib',
                'Drupal\\config' => '/vagrant/sites/drupal8/core/modules/config/lib',
                'Drupal\\contact' => '/vagrant/sites/drupal8/core/modules/contact/lib',
                'Drupal\\contextual' => '/vagrant/sites/drupal8/core/modules/contextual/lib',
                'Drupal\\custom_block' => '/vagrant/sites/drupal8/core/modules/block/custom_block/lib',
                'Drupal\\datetime' => '/vagrant/sites/drupal8/core/modules/datetime/lib',
                'Drupal\\dblog' => '/vagrant/sites/drupal8/core/modules/dblog/lib',
                'Drupal\\edit' => '/vagrant/sites/drupal8/core/modules/edit/lib',
                'Drupal\\editor' => '/vagrant/sites/drupal8/core/modules/editor/lib',
                'Drupal\\entity' => '/vagrant/sites/drupal8/core/modules/entity/lib',
                'Drupal\\entity_reference' => '/vagrant/sites/drupal8/core/modules/entity_reference/lib',
                'Drupal\\field' => '/vagrant/sites/drupal8/core/modules/field/lib',
                'Drupal\\field_ui' => '/vagrant/sites/drupal8/core/modules/field_ui/lib',
                'Drupal\\file' => '/vagrant/sites/drupal8/core/modules/file/lib',
                'Drupal\\filter' => '/vagrant/sites/drupal8/core/modules/filter/lib',
                'Drupal\\help' => '/vagrant/sites/drupal8/core/modules/help/lib',
                'Drupal\\history' => '/vagrant/sites/drupal8/core/modules/history/lib',
                'Drupal\\image' => '/vagrant/sites/drupal8/core/modules/image/lib',
                'Drupal\\menu' => '/vagrant/sites/drupal8/core/modules/menu/lib',
                'Drupal\\menu_link' => '/vagrant/sites/drupal8/core/modules/menu_link/lib',
                'Drupal\\node' => '/vagrant/sites/drupal8/core/modules/node/lib',
                'Drupal\\number' => '/vagrant/sites/drupal8/core/modules/number/lib',
                'Drupal\\options' => '/vagrant/sites/drupal8/core/modules/options/lib',
                'Drupal\\overlay' => '/vagrant/sites/drupal8/core/modules/overlay/lib',
                'Drupal\\path' => '/vagrant/sites/drupal8/core/modules/path/lib',
                'Drupal\\rdf' => '/vagrant/sites/drupal8/core/modules/rdf/lib',
                'Drupal\\search' => '/vagrant/sites/drupal8/core/modules/search/lib',
                'Drupal\\shortcut' => '/vagrant/sites/drupal8/core/modules/shortcut/lib',
                'Drupal\\system' => '/vagrant/sites/drupal8/core/modules/system/lib',
                'Drupal\\taxonomy' => '/vagrant/sites/drupal8/core/modules/taxonomy/lib',
                'Drupal\\text' => '/vagrant/sites/drupal8/core/modules/text/lib',
                'Drupal\\toolbar' => '/vagrant/sites/drupal8/core/modules/toolbar/lib',
                'Drupal\\tour' => '/vagrant/sites/drupal8/core/modules/tour/lib',
                'Drupal\\update' => '/vagrant/sites/drupal8/core/modules/update/lib',
                'Drupal\\user' => '/vagrant/sites/drupal8/core/modules/user/lib',
                'Drupal\\views_ui' => '/vagrant/sites/drupal8/core/modules/views_ui/lib',
                'Drupal\\views' => '/vagrant/sites/drupal8/core/modules/views/lib',
                'Drupal\\standard' => '/vagrant/sites/drupal8/core/profiles/standard/lib',
                'Drupal\\Core\\Entity' => '/vagrant/sites/drupal8/core/lib',
                'Drupal\\Core\\Field' => '/vagrant/sites/drupal8/core/lib',
                'Drupal\\Core\\Http' => '/vagrant/sites/drupal8/core/lib',
                'Drupal\\Core\\TypedData' => '/vagrant/sites/drupal8/core/lib',
                'Drupal\\Core\\Validation' => '/vagrant/sites/drupal8/core/lib',
